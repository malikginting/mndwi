...
st.set_page_config(
    ...
    menu_items={
            'About': "This app was developped by [IndigoWizard](https://github.com/IndigoWizard/mndwi-Viewer) for the purpose of environmental monitoring and geospatial analysis"
    }
)
...
def upload_files_proc(upload_files):
    ...
    if geometry_aoi_list:
        ...
        geometry_aoi = ee.Geometry.Point([-6.23, 106.75])
